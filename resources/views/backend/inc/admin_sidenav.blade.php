<div class="aiz-sidebar-wrap">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.contents') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Content') }}</span>
                                </a>
                            </li>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('user_feedback_form.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('User Feedback') }}</span>
                            </a>
                        </li>
                        </ul>
                    </li>
 ...
 <li class="aiz-side-nav-item">
     ...
     <li class="aiz-side-nav-item">
         <a href="{{ route('surveys.index') }}" class="aiz-side-nav-link">
             <span class="aiz-side-nav-text">{{ translate('Surveys') }}</span>
         </a>
     </li>
     <li class="aiz-side-nav-item">
        <a href="{{ route('questions.index') }}" class="aiz-side-nav-link">
            <span class="aiz-side-nav-text">{{ translate('Questions') }}</span>
        </a>
    </li>
    <li class="aiz-side-nav-item">
        <a href="{{ route('feedbacks.index') }}" class="aiz-side-nav-link">
                ...
                <!--Blog System-->
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('blog-setting.index') }}" class="aiz-side-nav-link ">
