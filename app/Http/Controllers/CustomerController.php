...
class CustomerController extends Controller
{
    ...
    public function destroyPostByAdmin($id)
    {

        if(Post::destroy($id)){
            flash(translate('Post has been deleted successfully'))->success();
            return  back();
        }
...
$sort_search = null;
        ...
        return view('backend.customer.customers.content', compact('posts', 'sort_search'));
        }
        public function post($id){
            $post = Post::findOrFail($id);
            return view('backend.customer.customers.post',compact('post'));
        }
        public function setting(){

            return view('backend.customer.customers.setting');
       }
