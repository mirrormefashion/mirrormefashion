...
class BusinessSettingsController extends Controller
{
   ...
   public function user_feedback_form(Request $request)
    {
    	return view('backend.user_feedback.index');
    }
   /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function user_feedback_form_update(Request $request)
    {
  ...
  /*      dd($request->all()); */
        ...
        $business_settings = BusinessSetting::where('type', 'user_feedback_form')->first();
       
        if(!$business_settings) {
            $business_settings = new BusinessSetting;
            $business_settings->type = 'user_feedback_form';
        }
