...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('customer/contents', 'CustomerController@contents')->name('customers.contents');
    Route::get('customer/{id}/post', 'CustomerController@post')->name('customers.post');
    Route::get('customer/setting', 'CustomerController@setting')->name('customers.setting');
    Route::get('customer/contents/destroy/{id}', 'CustomerController@destroyPostByAdmin')->name('post.destroy-by-admin');
    ...
    Route::get('/user_feedback/form', 'BusinessSettingsController@user_feedback_form')->name('user_feedback_form.index');
    Route::post('/user_feedback/form', 'BusinessSettingsController@user_feedback_form_update')->name('user_feedback_form.update');
    Route::get('/survey', 'SurveyController@index')->name('surveys.index');
    Route::get('/surveys', 'SurveyController@create')->name('surveys.create');
    Route::post('/surveys', 'SurveyController@store')->name('surveys.store');
    Route::get('/surveys/{id}/edit', 'SurveyController@show')->name('surveys.edit');
    Route::post('/surveys/update', 'SurveyController@update')->name('surveys.update');
    Route::get('/surveys/{id}/destroy', 'SurveyController@destroy')->name('surveys.destroy');
    Route::get('survey/questions', 'QuestionController@index')->name('questions.index');
    Route::post('survey/questions', 'QuestionController@store')->name('questions.store');
    Route::get('survey/questions/create', 'QuestionController@create')->name('questions.create');
    Route::get('survey/questions/{id}', 'QuestionController@edit')->name('questions.edit');
    Route::get('survey/questions/destroy/{id}', 'QuestionController@destroy')->name('questions.destroy');
    Route::get('survey/feedbacks', 'FeedbackController@index')->name('feedbacks.index');
    Route::get('survey/feedbacks/{id}', 'FeedbackController@show')->name('feedbacks.show');
    Route::get('survey/feedbacks/destroy/{id}', 'FeedbackController@destroy')->name('feedbacks.destroy');
    Route::post('/user_feedback/form', 'BusinessSettingsController@user_feedback_form_update')->name('user_feedback_form.update');
 ...
 Route::get('/blog-setting','BlogController@setting')->name('blog-setting.index');
